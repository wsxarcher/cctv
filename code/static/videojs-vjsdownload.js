// https://github.com/7Ds7/videojs-vjsdownload/blob/master/src/plugin.js
...
class DownloadButton extends vjsButton {
  ...
  */
  handleClick() {
    ...
    // Fix download same page
    var link = document.createElement('a');
    link.href = this.options_.downloadURL || p.currentSrc();
    link.download = this.options_.downloadURL || p.currentSrc();
    link.click();
    link.remove();
